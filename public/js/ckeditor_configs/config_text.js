...
CKEDITOR.editorConfig = function( config ) {
	config.toolbarGroups = [
        ...
        config.height = 100;
        config.width = '100%';
        config.removeButtons = 'Save,NewPage,ExportPdf,Preview,Print,Templates,PasteFromWord,Find,Replace,Scayt,CopyFormatting,Language,Anchor,Smiley,PageBreak,Font,Format,BGColor,ShowBlocks,About';
        config.extraPlugins= 'markdown';
        config.markdown = {
            lineWrapping: true
        }
