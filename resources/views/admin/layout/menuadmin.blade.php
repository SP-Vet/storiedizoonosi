<div class="list-group list-group-flush">
    ...
    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?=(isset($menuactive) && $menuactive=='zoonosi')?'active':'';?>" href="{{route('adminListZoonoses')}}"><i class="fa fa-bug"></i>&nbsp;Zoonosi<span class="badge bg-danger fRight"></span></a>
    ...
    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?=(isset($menuactive) && $menuactive=='approfondimenti')?'active':'';?>" href="{{route('adminListIntegrations')}}"><i class="fa fa-comment-o"></i>&nbsp;Integrazioni<span class="badge bg-danger fRight menu-notificaapprofondimenti"></span></a>
