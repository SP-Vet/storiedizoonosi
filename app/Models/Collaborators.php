...
use DB;
/**
 * Manages all the tables connected to collaborators 
 * 
...
class Collaborators extends Model
{
    ...
    /**
     * Method that get all collaborators stored in the db 
     *
     *  @param Integer $order the sorting conditions in queries 
     *                  [sorting 1: cognome, nome; 2: nome, cognome]
     *  @return Object
     */
    ...
    /**
     * Method that delete all the collaborators of a specific story
     *
    ...
    /**
     * Method that add a group of collaborators to a specific story
     *
     *  @param Integer $sid id of the story
     *  @param Array $collaboratori array of id's collaborators 
     *  @param Array $ruoli array of all roles availabels
     *  @return BOOL
     */
